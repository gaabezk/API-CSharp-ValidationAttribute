...
namespace API.Controllers
{
    ...
    public class UsuarioController : ControllerBase
    {
        ...
        public async Task<IActionResult> PutUsuario(int id, UsuarioDTO usuario)
        {
            ...
            if (usuario.NomeCompleto != null && !usuario.NomeCompleto.Equals(""))
            {
        ...
        {
            var user = await _context.Usuario.FirstOrDefaultAsync(p => p.Email == usuario.Email);
            if (user != null)
                return BadRequest("Email Ja registrado = " + user.Email);
